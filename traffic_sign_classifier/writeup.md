...
I used plain python functions to calculate summary statistics of the traffic signs data set:
...
Here is an exploratory visualization of the data set. It contains the first image from each label category
...
The code for this step is contained in the fourth code cell of the IPython notebook. I decided to do some preprocessing 
on the image to resize it to a 32x32 image followed by normalization. 
...
The data is already pickled as train, valid and test sets. The code for loading the data is in the first code cell of the 
IPython notebook.

As mentioned before, the training set has 34799 images, validation set has 4410 images and test set has 12630 images
...
Initially with random normal distributions for the weights, the accuracy was very low. Once this was changed to 
